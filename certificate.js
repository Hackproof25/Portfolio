...
const commands = {
    ...
    contacts: 'Navigating to Contacts page...',
    clear: 'Terminal cleared.' // Added clear command
};

// Initial welcome message
const welcomeMessage = '<p>PORTFOLIO-[$]~ Welcome to the terminal . . . <br><br>[$]~ USE COMMANDS:-</p>1. index<br>2. about<br>3. education<br>4. skills<br>5. projects<br>6. hobbies<br>7. contact<br>8. clear';
