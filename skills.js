...
const commands = {
    ...
    certificates: 'Navigating to Certificates page...',
...
const welcomeMessage = '<p>PORTFOLIO-[$]~ Welcome to the terminal . . . <br><br>[$]~ USE COMMANDS:-</p>1. index<br>2. about<br>3. education<br>4. certificates<br>5. projects<br>6. hobbies<br>7. contact<br>8. clear';
...
document.querySelector('.terminal-input').addEventListener('keydown', processInput);
